...
const {rooms, navigate, currency}=useAppContext();
 ...
 //Function to check if a room matchs the selected price range
...
const clearFilters=()=>{
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:px-16 lg:px-24'>
   <div> 
   <div className='flex flex-col item-start text-left'>
    <h1 className='font-playfair text-4xl md:text-[40px]'> Hotel Rooms</h1>
    <p className='text-sm md:text-base text-gray-500/90 mt-2'>Take advantage of our limited-time offers and special packages to enhance your stay and create 
    unforgettable memories.</p>
   </div>
  {filteredRooms.map((room)=>(
    <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 lasat:pb-30 last:border-0'>
   ...
   {/* Filter*/}
   <div className='bg-white w-80 border border-gray-300 max-lg:mb-8 min-lg:mt-16'>
