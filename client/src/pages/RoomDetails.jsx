    ...
    const checkAvailability=async()=>{
      try{
        if(checkInDate >= checkOutDate){
          toast.error('Check-In Date should b lss than Check-out Date')
          return;
        }
          ...
          <span>{room.hotel.address}</span>
            ...
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
             ...
             <p className='text-2xl font-medium'>${room.pricePerNight}/night</p>
              ...
              <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-10 max-w-6xl'>
