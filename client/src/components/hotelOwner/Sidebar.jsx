...
const Sidebar = () => {
    const sidebarLinks=[
        {name:"DashBboard",path:'/owner',icon:assets.dashboardIcon},
         {name:"Add Room",path:'/owner/add-room',icon:assets.addIcon},
          {name:"List Room",path:'/owner/list-room',icon:assets.listIcon},
    ]
  return (
    <div className='md:w-64 e-16 border-r h-full text-base bordere-gray-300 pt-4 flex flex-col transition-allduration-300'>
