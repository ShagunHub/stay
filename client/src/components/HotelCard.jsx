...
const HotelCard = ({room,index}) => {
  return (
    <Link to={`/rooms`} onClick={()=> window.scrollTo(0,0)} key={room._id}
    className='relative max-w-70 w-full round-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0,0.5)]'>
    <img src={room.images && room.images.length > 0 ? room.images[0] : assets.roomImg1} alt="" />
